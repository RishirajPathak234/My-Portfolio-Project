                    ...
                    <div className='mt-10'>
                        <div className='grid grid-cols-1 gap-12 lg:grid-cols-2'>
                            ...
                            <div>
                                ...
                                <a href="https://drive.google.com/file/d/19CT9NWANdxztFIyeU9XPJw7PZ16KjzQ_/view?usp=drive_link" className='mt-3 inline-block bg-blue-500 text-white font-bold py-2 px-4 rounded hover:bg-blue-700'>View Certificate</a>
                                ...
                                <a href="https://drive.google.com/file/d/1PM-npe__dMYBHOIT2Nk-VecyHxx9J-lV/view?usp=drive_link" className='mt-3 inline-block bg-blue-500 text-white font-bold py-2 px-4 rounded hover:bg-blue-700'>View Certificate</a>
                            ...
                            <div>
                                ...
                                <p className='mt-4 text-lg text-gray-700'>
                                    I have participated in the "Technopoly" competition held at the prestigious "G.H. Raisoni Institute of Engineering and Technology" and have successfully won the competition with the Title "Best Innovatio". In this competition, I have showcased my project "Automatic Fire Extinguisher For Electric Vehicles" which was based on the Internet of Things (IoT).</p>
                                <a href="https://drive.google.com/file/d/1QkdJFRJpJM3aJaYGqVd9qZlauNxL1jRw/view?usp=drive_link" className='mt-3 inline-block bg-blue-500 text-white font-bold py-2 px-4 rounded hover:bg-blue-700'>View Certificate</a>
                                ...
                                <a href="https://drive.google.com/file/d/1B0Qd28J3zNK9U37Mmi8njBsTDPW70gmL/view?usp=drive_link" className='mt-3 inline-block bg-blue-500 text-white font-bold py-2 px-4 rounded hover:bg-blue-700'>View Certificate</a>
                            </div>
                        </div>
                    </div>
                </div>
